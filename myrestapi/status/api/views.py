...
# class StatusListSearchAPIView(generics.ListAPIView, mixins.CreateModelMixin):
#     permission_classes          = []
#     authentication_classes      = []
#     serializer_class            = StatusSerializer
#     queryset                    = Status.objects.all()
...
# # class StatusCreateAPIView(mixins.CreateModelMixin, generics.ListAPIView): 
# #     permission_classes          = [permissions.IsAuthenticatedOrReadOnly]
# #     serializer_class            = StatusSerializer
# #     passed_id                   = None
...
# # class StatusUpdateAPIView(mixins.UpdateModelMixin, generics.ListAPIView): 
# #     permission_classes          = [permissions.IsAuthenticatedOrReadOnly]
# #     serializer_class            = StatusSerializer
# #     passed_id                   = None
# #     search_fields               = ('user__username', 'content', 'user__email')
...
# # class StatusDeleteAPIView(mixins.DestroyModelMixin, generics.ListAPIView): 
# #     permission_classes          = [permissions.IsAuthenticatedOrReadOnly]
# #     serializer_class            = StatusSerializer
# #     passed_id                   = None
# #     search_fields               = ('user__username', 'content', 'user__email')
